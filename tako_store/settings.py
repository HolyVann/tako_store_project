"""
Django settings for tako_store project.
...
SECRET_KEY = 'django-insecure-s_agoa30cr2@f#f*vg$ukr3^h#2hcdwk02c#1xm_%6n^@_qbv9'
...
WSGI_APPLICATION = 'tako_store.wsgi.application'
